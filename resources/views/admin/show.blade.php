                ...
                <div class="col">      
                    ...
                    @if ($post->image)
                        <div class="d-flex justify-content-center">
                            <img src="{{ asset('storage/images/' . $post->image) }}" alt="{{ $post->slug }}" class="img-fluid my-3" width="auto">
                        </div>
                    @endif
                                ...
                                <div class="card border-light mb-0">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <form action="{{ route('comment.destroy', $komen->id) }}" method="post" onsubmit="return confirm('Apakah anda ingin menghapus komentar?')">
                                                @csrf
                                                @method('delete')
                                                <button class="btn btn-danger btn-sm p-2"><i class="bi bi-trash"></i></button>
                                            </form>
                                        </div>
                                        <hr class="mt-0">
